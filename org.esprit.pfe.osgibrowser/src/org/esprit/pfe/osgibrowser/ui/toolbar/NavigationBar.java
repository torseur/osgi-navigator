...
public class NavigationBar {
	...
	//UI elements
	public ToolBarManager navigationTBManager = null;
...
//		super( parent, style );
	...
	protected void createUI(Composite parent){
		final Composite navigationBar = new Composite(parent, SWT.None);
		This = navigationBar;
		...
		navigationBar.setLayout(gridLayout);
		...
		//navigationTBManager.createControl(navigationBar);
		
		ToolItem tltmNewItem = new ToolItem(navigationTBManager.createControl(navigationBar), SWT.NONE);
		tltmNewItem.setText("new");
		
		
		
		location = new Text(navigationBar, SWT.BORDER);
		location.setText( "http://" );
		GridData data = new GridData( GridData.FILL_HORIZONTAL );
		location.setLayoutData( data );
		//navigationBar.setLayoutData(data);
		...
		extensibleTBManager.createControl( navigationBar );
		...
		Action openExtensibleMenuAction = new Action(){
			...
			public void run() {
				...
				Menu aMenu = extensibleMenuManager.createContextMenu( navigationBar );
	...
	public ToolBar getToolBarLeftMenu(){
		return navigationTBManager.getControl();
	}
	public Composite getThis(){
		return This;
	}
